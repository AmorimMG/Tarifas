...
import TarifasFormPage from 'pages/CRUD/Tarifas/form/TarifasFormPage';
import TarifasTablePage from 'pages/CRUD/Tarifas/table/TarifasTablePage';
        ...
        <div className={classes.root}>
            ...
            >
                ...
                <Switch>
                    ...
                    <Route path={"/admin/tarifas"} exact component={TarifasTablePage} />
                    <Route path={"/admin/tarifas/new"} exact component={TarifasFormPage} />
                    <Route path={"/admin/tarifas/:id/edit"} exact component={TarifasFormPage} />
